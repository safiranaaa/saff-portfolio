...
const ProjectDetail = () => {
  ...
  const projectsData: Record<string, any> = {
    "guardcare-child-nutritional-status": {
      ...
      mockups: [
        `${baseUrl}assets/projects/guardcare1.png`,
        `${baseUrl}assets/projects/guardcare2.png`,
        `${baseUrl}assets/projects/guardcare3.jpg`,
        `${baseUrl}assets/projects/guardcare4.jpg`,
        `${baseUrl}assets/projects/guardcare5.jpg`,
        `${baseUrl}assets/projects/guardcare6.jpg`,
        `${baseUrl}assets/projects/guardcare7.jpg`,
        `${baseUrl}assets/projects/guardcare8.jpg`
      ]
    },
    "mental-health-estimation": {
      ...
      mockups: [
        `${baseUrl}assets/projects/mentalHealth4.png.png`,
        `${baseUrl}assets/projects/mentalHealth3.png.png`,
        `${baseUrl}assets/projects/mentalHealth2.png.png`,
        `${baseUrl}assets/projects/mentalHealth1.png.png`
      ]
    },
    "bmr-calculator-android": {
      ...
      mockups: [
        `${baseUrl}assets/projects/bmr1.png`,
        `${baseUrl}assets/projects/bmr2.png`
      ]
    },
    "ecommerce-website": {
      ...
      mockups: [
        `${baseUrl}assets/projects/cantik1.png`,
        `${baseUrl}assets/projects/cantik2.png`
      ]
    },
    "kangen-omah-prototypes": {
      ...
      mockups: [
        `${baseUrl}assets/projects/kom1.png`,
        `${baseUrl}assets/projects/kom2.png`,
        `${baseUrl}assets/projects/kom3.png`,
        `${baseUrl}assets/projects/kom4.png`,
        `${baseUrl}assets/projects/kow1.png`,
        `${baseUrl}assets/projects/kow2.png`,
        `${baseUrl}assets/projects/kow3.png`,
        `${baseUrl}assets/projects/kow4.png`
      ]
    },
    "android-health-tracking": {
      ...
      mockups: [
        `${baseUrl}assets/projects/htrack1.png`,
        `${baseUrl}assets/projects/htrack2.png`,
        `${baseUrl}assets/projects/htrack3.png`,
        `${baseUrl}assets/projects/htrack4.png`,
        `${baseUrl}assets/projects/htrack5.png`
      ]
    }
  };
